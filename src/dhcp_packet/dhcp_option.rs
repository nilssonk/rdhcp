...
pub enum DhcpOption<'a> {
    ...
    Ipv4FqdnMos(option::Ipv4FqdnMos),
...
impl<'a> DhcpOption<'a> {
    ...
    pub(crate) fn try_decode(data: &'a [u8]) -> Option<Self> {
        ...
        let decode_fn: fn(&[u8]) -> Option<DhcpOption> = match tag {
            ...
            152 => option::PcpServer::decode,
            153 => option::Polycom::decode,
            //   154 => option::MudUrl::decode,
            ...
            162 => option::AccessDomain::decode,
    ...
    pub fn get_length(&self) -> usize {
        match self {
            Self::Padding(padding) => padding.data.len(),
            Self::MagicCookie(_) => 4,
            Self::End => 1,
